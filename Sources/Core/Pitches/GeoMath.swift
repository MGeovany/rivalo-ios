...
/// Small geodesy helpers for the "walk two points" pitch measurement: distance,
...
enum GeoMath {
    ...
    /// Midpoint between two coordinates. A plain average is accurate enough over
    /// the ~100 m span of a pitch.
